...
function loadPlugin(name, config) {
  ...
  if (pluginCoin !== activeCoin && !configuredCoins[activeCoin]) {
    activeCoin = pluginCoin;
  }
...
function loadOrConfigPluginCoin(pluginHandle, pluginType, currency,
    onChangeCallback, coin) {
  var pluginChanged;
  var currentName = cachedConfig.exchanges.plugins.current[coin + pluginType];
...
exports.setActiveCoin = function(session, req, cb) {
  var coin = req.coin;
  var err = null;
  var code = 200;
